...
import 'package:keley_app/routing/router.dart' as router;
import 'package:keley_app/routing/routings_constants.dart';
import 'package:provider/provider.dart';

void main() {
  //runApp(ChangeNotifierProvider(child: MyApp(), create: (context) =>  LoginScreenModel(context: null),) );
  runApp(MyApp());
}
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        initialRoute: RoutingConstants.OnBoardingViewRoute,
